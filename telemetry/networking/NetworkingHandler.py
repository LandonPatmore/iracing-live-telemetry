...
class NetworkingHandler:
    def __init__(self, websocket_url: str, receiver_queue: Queue, streaming_queue: Queue, pushable_queue: Queue):
        ...
        self.network_sender = NetworkSender(pushable_queue=pushable_queue)
